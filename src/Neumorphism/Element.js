...
export function ElementFlat (backgroundColor){
    return `<svg
...
export function ElementConvex (backgroundColor){
    return `<svg
    xmlns="http://www.w3.org/2000/svg"
    width="100"
    height="24"
...
export function ElementConcave (backgroundColor){
    return `<svg
    xmlns="http://www.w3.org/2000/svg"
    width="100"
    height="24"
...
export function ElementPressed (backgroundColor){
    return `<svg
    xmlns="http://www.w3.org/2000/svg"
    width="100"
    height="24"
