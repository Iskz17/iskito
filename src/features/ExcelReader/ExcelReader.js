...
const ExcelReader = (props) => {
      ...
      >
        ...
        >
          <Tooltip title="Upload workers data">
            ...
            >
              {" "}
              {t("excelReader.table.uploadExcel")}
            </PrimaryButton>
          </Tooltip>
          <Tooltip title="Download filtered data">
            ...
            >
              {" "}
              {t("excelReader.table.downloadExcel")}
            </PrimaryButton>
          </Tooltip>
        </div>
      </Toolbar>
  ...
  return (
    ...
    >
      <Title
        title={t("excelReader.title")}
        description={t("excelReader.description")}
